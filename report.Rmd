...
Generative AI was used in this assignment. This report analyses a reduced World Values Survey dataset to investigate how participant attributes predict confidence in social organisations, with a specific focus on the Netherlands.
...
**APPENDIX B: GENERATIVE AI USE**

In this report, ChatGPT was used for debugging R code for any errors and warnings, and improving graph design and report structure.

Examples of the prompts included:

- "How can I visualize changes in confidence over time by wave?"

- "How should I structure this assignment report in R Markdown?"

The generated outputs were used only as guidance for coding and presentation. All generated suggestions were reviewed, and tested before use.
The final dataset creation, cleaning, modelling, figures, and conclusions were done by me.